...
class REDownloader:
    def __init__(self, ons_code, empresa, categoria):
        self.ons_code = ons_code
        self.empresa = empresa
        self.categoria = categoria
        # ... existing code ...
        self.base_path = os.path.join(r"C:\Users\Bruno\Downloads\TUST\VERENE", categoria, str(ons_code))
    ...
    def run(self):
        try:
            print(f"\nIniciando download para {self.empresa} (ONS: {self.ons_code}, Categoria: {self.categoria})")
...
def main():
    # Dicionário com as categorias e suas respectivas empresas
    categorias = {
        "AE": [
    ...
    # Processa cada categoria e suas empresas
    for categoria, empresas in categorias.items():
        print(f"\n=== Processando categoria: {categoria} ===")
        for ons_code, empresa in empresas:
            downloader = REDownloader(ons_code, empresa, categoria)
            downloader.run()
