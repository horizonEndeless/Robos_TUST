...
EMPRESAS = [
    {"cnpj": "30520122000170", "nome": "SJP1"},
    {"cnpj": "30432072000179", "nome": "SJP2"},
    {"cnpj": "30486042000145", "nome": "SJP3"},
    {"cnpj": "30425445000184", "nome": "SJP4"},
    {"cnpj": "30456405000108", "nome": "SJP5"},
    {"cnpj": "30421756000175", "nome": "SJP6"},
    {"cnpj": "14285232000148", "nome": "COR1"},
    {"cnpj": "14285242000183", "nome": "COR2"},
    {"cnpj": "24342513000149", "nome": "COR3"},
    {"cnpj": "10500221000182", "nome": "LIBRA"}
]
...
def criar_estrutura_pastas(mes, ano, empresa, numero_fatura):
    ...
    """
    base_path = os.path.join(os.path.expanduser("~"), "Downloads", "TUST","AE","CPFL", f"{mes:02d}_{ano}", empresa, f"NF_{numero_fatura}")
...
def processar_todas_empresas(mes=10, ano=2024):
    ...
    for empresa in EMPRESAS:
        try:
            ...
            login_cpfl(empresa['cnpj'], "America!2024", mes, ano)
