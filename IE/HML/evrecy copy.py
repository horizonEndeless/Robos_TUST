        ...
        if isinstance(credencial["pasta_base"], str):  # Se for LIBRAS
            ...
            if sessao:
                ...
                if resultado:
                    ...
                    base_path = os.path.join(r"C:\Users\Bruno\Downloads\TUST\EVRECRY", credencial["pasta_base"])
            ...
            if sessao:
                ...
                if resultado:
                    ...
                    for i, transmissora in enumerate(transmissoras):
                        ...
                        base_path = os.path.join(r"C:\Users\Bruno\Downloads\TUST\IEVRECY", pasta_base)
