...
class SigetPlusDownloader:
    ...
    def __init__(self, download_dir=None, wkhtmltopdf_path=None):
        ...
        if download_dir:
            ...
            self.download_dir = os.path.join(os.path.expanduser("~"), "Downloads", "TUST", "LNT", "RE")
...
if __name__ == "__main__":
    ...
    print(f"Diretório base: C:\\Users\\Bruno\\Downloads\\TUST\\LNT\\RE")
    print("=" * 50)
    ...
    download_dir = "C:\\Users\\Bruno\\Downloads\\TUST\\LNT\\RE"
