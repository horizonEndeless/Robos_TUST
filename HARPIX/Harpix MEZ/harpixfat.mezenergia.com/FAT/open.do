...
<html class="w-100 h-100">
    <head>
        ...
        <script type="text/javascript">
            ...
            var isTomcat7 = false;
            var isPopup = false;
            var formId = $mainform().URLEncode('3');
            var codigo = 'null';
            ...
            var SESSION_ID = '3dkjrnjzl5z4pi11c1glkvp0';
    ...
    <body class="w-100 h-100" onload="formOnLoadAction()" onunload="formOnUnLoadAction()" onbeforeunload="formOnUnLoadAction()">
        ...
        <iframe onload="removeLoadingSpinner()" src="openform.do?sys=FAT&action=openform&formID=3&firstLoad=true" name="mainform" class="position-absolute border-0 w-100 h-100 m-0 overflow-auto" scrolling="yes"></iframe>
