...
<html class="w-100 h-100">
    <head>
        ...
        <script type="text/javascript">
            ...
            var isTomcat7 = false;
            var isPopup = false;
            var formId = $mainform().URLEncode('500000435');
            var codigo = 'null';
    ...
    <body class="w-100 h-100" onload="formOnLoadAction()" onunload="formOnUnLoadAction()" onbeforeunload="formOnUnLoadAction()">
        ...
        <iframe onload="removeLoadingSpinner()" src="openform.do?sys=FAT&action=openform&formID=500000435&mode=-1&goto=-1&filter=&scrolling=False&firstLoad=true" name="mainform" class="position-absolute border-0 w-100 h-100 m-0 overflow-auto" scrolling="yes"></iframe>
