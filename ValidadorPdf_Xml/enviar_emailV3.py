...
def search_emails(mail, sender, month_year):
    query = f'FROM "{sender}"'
    ...
    for e_id in email_ids:
        ...
        if parsed_date.strftime("%m-%Y") == month_year:
...
def main():
    sender = "HRZTMAII@hrztransmissoras.com.br"
    month_year = "02-2025"
    
    mail = connect_imap()
    emails_to_forward = search_emails(mail, sender, month_year)
