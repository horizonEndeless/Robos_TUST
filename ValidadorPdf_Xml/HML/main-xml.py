...
def processar_pasta_xml(pasta_entrada, df_empresas):
    """Processa todos os arquivos XML na pasta e renomeia no local"""
    ...
    for arquivo in arquivos_xml:
        ...
        if info:
            print(f"CNPJ Destinatário encontrado: {info['dest_cnpj']}")
            ...
            if not cnpj_match.empty:
                ...
                print(f"CNPJ {info['dest_cnpj']} não encontrado na tabela")
        else:
...
def main():
    print("Iniciando programa de processamento de XML")
    pasta_entrada = input("Digite o caminho da pasta com os arquivos XML: ")
    
    print("\nCarregando tabela de empresas...")
    df_empresas = criar_df_empresas()
    print(f"Tabela carregada com {len(df_empresas)} empresas")
    
    processar_pasta_xml(pasta_entrada, df_empresas)
