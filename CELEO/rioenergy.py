...
def baixar_faturas(codigo_ons):
    print(f"Iniciando busca de faturas para o código ONS: {codigo_ons}")
    
    # Define o caminho base incluindo a pasta RE e o código ONS
    caminho_base = os.path.join(r"C:\Users\Bruno\Downloads\CELEO", "RE", codigo_ons)
    ...
    if response_default.ok:
        # Prepara os dados para o POST no formato correto
        post_data = {'txtNordem': codigo_ons}  # Mudando para dicionário
                ...
                for row in rows[1:]:  # Ignora o cabeçalho
                    ...
                    if len(columns) >= 10:
                        try:
                            ...
                            caminho_base = os.path.join(r"C:\Users\Bruno\Downloads\CELEO", "AE", codigo_ons)
                            os.makedirs(caminho_base, exist_ok=True)
...
if __name__ == "__main__":
    codigos_ons = [
        "3859", "3860", "3861", "3862", "3863", "3864", "3740", "3741",
        "3750", "8011"
    ]  # Códigos da RE e AE
    for codigo in codigos_ons:
        print(f"\nTestando código ONS: {codigo}")
        baixar_faturas(codigo)
